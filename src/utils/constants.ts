...
export const SEARCH_PLAYLIST_FUNCTION_URL = process.env.REACT_APP_SEARCH_PLAYLIST_FUNCTION_URL || "https://tuneshift.netlify.app/.netlify/functions/search-playlist";
